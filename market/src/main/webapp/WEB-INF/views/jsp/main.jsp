            ...
            <c:forEach items="${productList}" var="productVO">
	            <div class="main_product_div">
	            	<a class="main_product_div_a" href="#">
		                <img class="product_img" src="http://cjhftp.dothome.co.kr/${producVO.memberno}/board/${product.imagename}">
		                <div class="main_product_title" >${productVO.title }</div><br>
		                <div class="main_product_address">${productVO.address }</div><br>
		                <input type="text" value ="${productVO.memberno }">
		                <input type="text" value ="${productVO.boardno }">
		                <div>
