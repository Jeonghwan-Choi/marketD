	                ...
	                if($("#roomno").val()==jbSplit[1]){    
	                    if($("#memberno").val()==jbSplit[2]){
	                    	 if(jbSplit[5]==1){
	                    		...
	                    		//c
	                    		$(' <div class="c"><div class="chat_box_p_div"><img src="http://cjhftp.dothome.co.kr/'+jbSplit[2]+'/profile/'+$('#profilename').val()+'">'+
	                               '</div><div class="chat_box_m_div" ><div>일정이 공유되었어요.</div><div id="staticMap" class="chat_box_m_div_map"></div>'+
	                                   ' <div class="chat_box_m_div_date">날짜: '+jbSplit[9]+'</div><div class="chat_box_m_div_location">장소: '+jbSplit[6]+'</div>'+
	                                '<input type="button" value= "일정보기"></div><div class="chat_box_m_div_time_div"><span class="chat_box_m_div_time" >'+jbSplit[4]+'</span></div></div>').appendTo("#chat_box_ms");	
	                    	...
	                    	if($("."+$("#roomno").val()+"-"+$("#memberno").val()).html()==1){
	                    		...
	                    		if(jbSplit[5]==1){
	                    			...
	                    			$(' <div class="d"><div class="chat_box_m_div_time_div"><span class="chat_box_m_div_time" >'+jbSplit[4]+'</span></div>'+
	 	                    	           '<div class="chat_box_m_div" ><div> 일정이 공유되었어요.</div<div id="staticMap" class="chat_box_m_div_map">'+
		                    	           '</div><div class="chat_box_m_div_date">날짜: '+jbSplit[9]+'</div><div class="chat_box_m_div_location">장소: '+jbSplit[6]+'</div>'+
		                    	           '<input type="button" value= "일정보기"></div><div class="chat_box_p_div"><img src="http://cjhftp.dothome.co.kr/'+jbSplit[2]+'/profile/'+$("#myprofilename").val()+'" ></div></div>').appendTo("#chat_box_ms");
	                    		}
