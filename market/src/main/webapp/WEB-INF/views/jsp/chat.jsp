      ...
      $("#msg_location").click(function(){
         ...
         var location = $('#location').val();
          var calendarLocationno = 0;
            window.open("chatlocation?user1="+user1+"&user2="+user2+"&chatroomno="+chatroomno+"&locationjsp="+location+"&calendarLocationno="+calendarLocationno, "_blank", "width=900, height=720,toolbar=no,location=no,resizable=no,left=30,top=30,menubar=no" ); 
